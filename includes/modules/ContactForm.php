...
<tr>
  <td width="150" class="main" height="30"><?php echo FORM_ADRESSE; ?>  :</td><td><input type="text" name="FORM_ADRESSE" class="main" style="color:#000;width:150px;border:1px solid #000;"></td>
</tr>
<tr>
...
<tr>
  <td width="150" class="main" height="30"><?php echo FORM_VILLE; ?>  :</td><td><input type="text" name="FORM_VILLE" class="main" style="color:#000;width:100px;border:1px solid #000;"></td>
</tr>
<tr>
...
<tr>
  <td></td><td class="main" style=""><br /><input type="submit" name="CONTACT_FORM_ENVOYER" value="<?php echo FORM_ENVOYER; ?>" style="color:#000;border:1px solid #000;width:100px;"></td>
</tr>
</table>
