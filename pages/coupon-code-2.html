                ...
                <div class="container_grid clearfix">
                    <div class="grid_12">
                        <div class="header-content clearfix">
                            <h1 id="logo" class="rs">
                                <a href="http://envato.megadrupal.com/html/couponday/gray/index.html">
                            ...
                            <div class="wrap-form-reg clearfix">
                                <form action="#">
                                    ...
                                    <div class="right-create-acc">
                                        ...
                                        <a id="sys_link_reg_panel" href="http://envato.megadrupal.com/html/couponday/gray/register.html" class="btn-flat yellow btn-submit-reg">Create an account</a>
                                        <div style="display: block;" id="sys_warning_sms" class="warning-sms" data-warning-txt="No spam guarantee,No disturb,Promotion News">No spam guarantee</div>
                                    </div>
                                </form>
                                <i class="line-sep"></i>
                            </div>
...
promotions from Coupons.com. Enter in an email and a password or sign up
 with Facebook.</div>
                            ...
                            <p class="rs wrap-link-back">
                                <a id="sys_link_login_panel" href="http://envato.megadrupal.com/html/couponday/gray/login.html" class="link-back">
                                    <i class="pick-r"></i>
                                    Back to login
                                </a>
                            </p>
        ...
        <nav id="mp-menu" class="mp-menu alternate-menu mp-overlap right-side">
            <div data-level="1" class="mp-level">
                <h2>Menu</h2>
                <ul>
                    <li><a href="http://envato.megadrupal.com/html/couponday/gray/index.html">Home</a></li>
                    <li><a href="http://envato.megadrupal.com/html/couponday/gray/coupon.html">Coupons</a></li>
                    <li class="has-sub">
                        <a href="http://envato.megadrupal.com/html/couponday/gray/coupon-code.html">Coupons Code</a>
                        <div data-level="2" class="mp-level">
                            <h2>Coupons Code</h2>
                            <a class="mp-back" href="#">back</a>
                            <ul>
                                <li><a href="http://envato.megadrupal.com/html/couponday/gray/coupon-code.html">Coupons Code 1</a></li>
                                <li><a href="http://envato.megadrupal.com/html/couponday/gray/coupon-code-2.html">Coupons Code 2</a></li>
                                            <li><a href="http://envato.megadrupal.com/html/couponday/gray/coupon-detail.html">Coupons Detail</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="has-sub">
                        <a href="http://envato.megadrupal.com/html/couponday/gray/brand-list.html">Brands</a>
                        <div data-level="2" class="mp-level">
                            <h2>Brands</h2>
                            <a class="mp-back" href="#">back</a>
                            <ul>
                                <li><a href="http://envato.megadrupal.com/html/couponday/gray/brand-detail-1.html">Brand Detail 1</a></li>
                                <li><a href="http://envato.megadrupal.com/html/couponday/gray/brand-detail-2.html">Brand Detail 2</a></li>
                                <li><a href="http://envato.megadrupal.com/html/couponday/gray/brand-detail-3.html">Brand Detail 3</a></li>
                                <li><a href="http://envato.megadrupal.com/html/couponday/gray/brand-detail-4.html">Brand Detail 4</a></li>
                                <li><a href="http://envato.megadrupal.com/html/couponday/gray/brand-detail-5.html">Brand Detail 5</a></li>
                            </ul>
                        </div>
                    </li>
                    <li><a href="http://envato.megadrupal.com/html/couponday/gray/blog.html">Blog</a></li>
                    <li><a href="http://envato.megadrupal.com/html/couponday/gray/my-coupon.html">My coupons(12)</a></li>
                    <li><a href="http://envato.megadrupal.com/html/couponday/gray/login.html">Login</a></li>
                </ul>
            </div>
        </nav><!--end: .mp-menu -->
        <div class="top-area">
                ...
                <div class="container_grid clearfix">
                    <div class="grid_12">
                        ...
                        <div class="range-days-left">
                            ...
                            <div id="sys_filter_days_left" class="filter-days noUi-target noUi-ltr noUi-horizontal noUi-background"><div class="noUi-base"><div style="left: 0%;" data-style="left" class="noUi-origin noUi-connect"><div class="noUi-handle noUi-handle-lower"></div></div><div style="left: 49.6855%;" data-style="left" class="noUi-origin noUi-background"><div class="noUi-handle noUi-handle-upper"></div></div></div></div>
                                    ...
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                ...
                                                <a href="#" class="ver_container"><img src="images/04-06.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="coupons-code-item right-action flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/04-02.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                ...
                                <div class="coupons-code-item right-action flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/04-04.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                ...
                                <div class="coupons-code-item right-action flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/04-05.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                        ...
                        <div class="mod-search block">
                            ...
                            <div class="block-content">
                                <label class="lbl-wrap" for="sys_search_coupon_code">
                                    <input class="keyword-search" id="sys_search_coupon_code" placeholder="Search" type="search">
                                    <input class="btn-search" value="" type="submit">
                                </label>
                            </div>
                        </div><!--end: .mod-search -->
                                ...
                                <div class="wrap-list-store clearfix">
                                    <a class="brand-logo" href="#">
                                        <span class="wrap-logo">
                                            <span class="center-img">
                                                <span class="ver_hold"></span>
                                                <span class="ver_container"><img src="images/04-07.jpg" alt="$BRAND_NAME"></span>
                                            </span>
                                        </span>
                                    </a>
                                    ...
                                    <a class="brand-logo" href="#">
                                        <span class="wrap-logo">
                                            <span class="center-img">
                                                <span class="ver_hold"></span>
                                                <span class="ver_container"><img src="images/04-12.jpg" alt="$BRAND_NAME"></span>
                                            </span>
                                        </span>
                                    </a>
                                    ...
                                    <a class="brand-logo" href="#">
                                        <span class="wrap-logo">
                                            <span class="center-img">
                                                <span class="ver_hold"></span>
                                                <span class="ver_container"><img src="images/04-11.jpg" alt="$BRAND_NAME"></span>
                                            </span>
                                        </span>
                                    </a>
                                    ...
                                    <a class="brand-logo" href="#">
                                        <span class="wrap-logo">
                                            <span class="center-img">
                                                <span class="ver_hold"></span>
                                                <span class="ver_container"><img src="images/04-10.jpg" alt="$BRAND_NAME"></span>
                                            </span>
                                        </span>
                                    </a>
                                    ...
                                    <a class="brand-logo" href="#">
                                        <span class="wrap-logo">
                                            <span class="center-img">
                                                <span class="ver_hold"></span>
                                                <span class="ver_container"><img src="images/04-09.jpg" alt="$BRAND_NAME"></span>
                                            </span>
                                        </span>
                                    </a>
                                    ...
                                    <a class="brand-logo" href="#">
                                        <span class="wrap-logo">
                                            <span class="center-img">
                                                <span class="ver_hold"></span>
                                                <span class="ver_container"><img src="images/04-08.jpg" alt="$BRAND_NAME"></span>
                                            </span>
                                        </span>
                                    </a>
                                </div>
                                ...
                                <div class="coupons-code-item simple flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/04-13.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                ...
                                <div class="coupons-code-item simple flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/04-14.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                ...
                                <div class="coupons-code-item simple flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/04-15.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                ...
                                <div class="coupons-code-item simple flex">
                                    <div class="brand-logo thumb-left">
                                        <div class="wrap-logo">
                                            <div class="center-img">
                                                <span class="ver_hold"></span>
                                                <a href="#" class="ver_container"><img src="images/04-16.jpg" alt="$BRAND_NAME"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="right-content flex-body">
                                ...
                                <div class="block-content">
                                    <div class="entry-item flex">
                                        <a class="thumb-left" href="#">
                                            <img src="images/04-13.jpg" alt="$TITLE">
                                        </a>
