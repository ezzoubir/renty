...
session_start();
$tinybrowser['sessioncheck'] = $_SESSION['id_membre']; //name of session variable to check
...
$tinybrowser['language'] = $_SESSION['language'];
else
...
if(isset($_SESSION['dossier_membre'])) $dossier_membre_=$_SESSION['dossier_membre'];else $dossier_membre_='';

$tinybrowser['path']['image'] = BASE_REP.'images/pages/images/'.$dossier_membre_; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = BASE_REP.'images/pages/media/'.$dossier_membre_; // Media files location
$tinybrowser['path']['file']  = BASE_REP.'images/pages/files/'.$dossier_membre_; // Other files location
