...
class paypal_class {
   ...
   var $last_error;                 // holds the last error encountered	var $ipn_log;                    // bool: log IPN results to text file?
   ...
   function submit_paypal_post() {
      ...
      //echo "<p style='text_align:center;'>Veuillez patientez pendant le traitement de votre paiement";
     // echo " Vous allez etre redirigé automatiquement sur paypal.</p>\n";	  echo "<img src='images/loading.gif' alt=''  onLoad=\"document.forms['paypal_form'].submit();\">";
    echo '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">'
		. '<html xmlns="http://www.w3.org/1999/xhtml"><head><title>Redirecting to PayPal...</title></head>'
		.'<body onload="document.paypal_form.submit();" style="background:#000;">';
		  echo "\n";	  echo "<center><img src='../images/loading.gif' </center><br /><br />
      <div style='color:#fff;'>".PATIENTEZ."</div>
      ";
     ...
     // echo "<br/><br/>Si vous n'etes pas automatiquement dirigé sur paypal  ";
     // echo "veuillez patienter 5 secondes...<br/><br/>\n";
     // echo "<center><input type=\"submit\" value=\"".FAIRE_DON_CONFIRMER."\"></center>\n";
      echo '</form></body></html>';
